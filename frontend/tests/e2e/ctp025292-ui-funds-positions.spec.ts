...
test("acct.ctp.live.025292 UI uses real-login source package or fails closed", async ({ page }, testInfo) => {
  ...
  const screenshot = path.join(evidenceDir, `${testInfo.project.name}-acct-ctp-live-025292.png`);
