...
export type { CommandApiBlocker } from "./types-shared";
...
export interface CommandApiResult {
  ...
  mode: string;
  status: "risk_gate_pending" | "blocked";
  command_id: string;
  intent_id: string;
  intent_ref: string;
  idempotency_key: string;
...
export interface CommandPlaneProjection {
  ...
  legacy_read_surfaces: string[];
  retired_archive_surfaces: Array<{
    route: string;
    archive_evidence_only: true;
    panel_ids: string[];
    historical_contract_ref: string;
    retirement_assertion: string;
  }>;
  action_surfaces: string[];
  retirement_guardrails: string[];
  retirement_slices: Array<{
    route: string;
    category: "retain_blocker_projection" | "converge_to_mirror_projection" | "retire_when_panels_removed";
    execution_state: "active_blocker_projection" | "retired_archive_only";
    panel_ids: string[];
    rationale: string;
    successor_surface: string;
  }>;
  retirement_batches: Array<{
    batch_id: string;
    execution_state: "planned_safe_retirement" | "completed_safe_retirement";
    route_count: number;
    panel_count: number;
    routes: string[];
    panel_ids: string[];
