...
from nautilus_account_console.ctp025292_consistency import (  # noqa: E402
...
def main() -> None:
    ...
    if args.write_blocker:
        ...
        result = evaluate_ctp025292_source_package(args.source_package)

    payload = result.to_dict()
    print(json.dumps(payload, sort_keys=True))
    if result.verdict == "passed":
        print("CTP025292_CONSISTENCY_OK: verdict=passed")
    elif result.verdict == "blocked":
        print(f"CTP025292_CONSISTENCY_BLOCKED: blocker={result.blocker_id}")
    else:
