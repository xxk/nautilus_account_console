...
| --- | --- | --- |
| [ADR-0005](0005-account-console-independent-broker-observation-sessions.md) | Account Console Independent Broker Observation Sessions | Decide whether Account Console may own governed, read-only CTP / IB TWS / stock / CQG / TT broker observation sessions for high-frequency account observation without becoming a second execution owner. |
