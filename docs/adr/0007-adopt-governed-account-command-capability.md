...
landing_status: p024_phase4b_runtime_approval_packet_ui_projection_gate
---
...
- ADR 类型：standard
- 决策状态：proposed
- 落地状态：p024_phase4b_runtime_approval_packet_ui_projection_gate
